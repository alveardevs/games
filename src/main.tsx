...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <body className='select-none relative h-full w-full text-foreground  max-w-[100vw] min-h-screen flex flex-col overflow-x-hidden bg-gradient-to-t from-slate-300 via-slate-50 to-slate-50'>
